...
def create_step11(output_path="step12.png"):
    fig, ax = plt.subplots(figsize=(3.2, 6.8))
    ...
    draw_noise(ax, x, 6.00, w, h)
    draw_accuracy(ax, x, 3.25, w, h)
    draw_reduced(ax, x, 0.50, w, h)
